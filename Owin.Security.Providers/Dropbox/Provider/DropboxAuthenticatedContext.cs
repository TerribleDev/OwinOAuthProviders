...
namespace Owin.Security.Providers.Dropbox
{
    ...
    {
        /// <summary>
        /// Initializes a <see cref="DropboxAuthenticatedContext"/>
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Contains the Dropbox user obtained from the endpoint https://api.dropbox.com/1/account/info
        /// </remarks>
        public JObject User { get; private set; }

        /// <summary>
        /// Gets the Dropbox OAuth access token
        /// </summary>
        public string AccessToken { get; private set; }

        /// <summary>
        /// Gets the Dropbox user ID
        /// </summary>
