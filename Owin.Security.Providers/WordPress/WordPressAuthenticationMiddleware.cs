...
namespace Owin.Security.Providers.WordPress
{
    public class WordPressAuthenticationMiddleware : AuthenticationMiddleware<WordPressAuthenticationOptions>
    {
            ...
            : base(next, options)
        {
            ...
            logger = app.CreateLogger<WordPressAuthenticationMiddleware>();
        ...
        {
            return new WordPressAuthenticationHandler(httpClient, logger);
        }

        private HttpMessageHandler ResolveHttpMessageHandler(WordPressAuthenticationOptions options)
        {
