...
namespace Owin.Security.Providers.Strava
{
    public static class StravaAuthenticationExtensions
    {
        ...
        public static IAppBuilder UseStravaAuthentication(this IAppBuilder app, string clientId, string clientSecret)
        {
            return app.UseStravaAuthentication(new StravaAuthenticationOptions
            {
                ClientId = clientId,
