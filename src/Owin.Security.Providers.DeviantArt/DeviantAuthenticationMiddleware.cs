...
namespace Owin.Security.Providers.DeviantArt
{
    public class DeviantArtAuthenticationMiddleware : AuthenticationMiddleware<DeviantArtAuthenticationOptions>
    {
            ...
            : base(next, options)
        {
            ...
            _logger = app.CreateLogger<DeviantArtAuthenticationMiddleware>();
            ...
            _httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Microsoft Owin DeviantArt middleware");
        ...
        {
            return new DeviantArtAuthenticationHandler(_httpClient, _logger);
        }

        private static HttpMessageHandler ResolveHttpMessageHandler(DeviantArtAuthenticationOptions options)
        {
