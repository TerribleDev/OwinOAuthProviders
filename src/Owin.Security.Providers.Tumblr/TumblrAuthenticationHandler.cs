...
{
    internal class TumblrAuthenticationHandler : AuthenticationHandler<TumblrAuthenticationOptions>
    {
        private static readonly DateTime Epoch = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        private const string StateCookie = "__TumblrState";
        private const string UserInfoEndpoint = "https://api.tumblr.com/v2/user/info";
        ...
        public TumblrAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new TumblrAuthenticatedContext(Context, accessToken)
                {
        ...
        protected override async Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                {
                    var tumblrAuthenticationEndpoint = AuthenticationEndpoint + requestToken.Token + "&perms=" + Options.Scope;
                    ...
                    Response.Headers.Set("Location", tumblrAuthenticationEndpoint);
                }
                else
                {
        ...
        public async Task<bool> InvokeReturnPathAsync()
        {
            ...
            var context = new TumblrReturnEndpointContext(Context, model)
            {
        ...
        private async Task<AccessToken> ObtainAccessTokenAsync(string appKey, string appSecret, RequestToken token, string verifier)
        {
            ...
            accessToken.User = await GetUserInfo(appKey, appSecret, accessToken);
            return accessToken;
        }
