...
namespace Owin.Security.Providers.Slack
{
    public class SlackAuthenticationMiddleware : AuthenticationMiddleware<SlackAuthenticationOptions>
    {
            ...
            : base(next, options)
        {
            ...
            _httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Microsoft Owin Slack middleware");
        ...
        private static HttpMessageHandler ResolveHttpMessageHandler(SlackAuthenticationOptions options)
        {
