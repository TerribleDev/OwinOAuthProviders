...
namespace Owin.Security.Providers.PayPal
{
    public class PayPalAuthenticationMiddleware : AuthenticationMiddleware<PayPalAuthenticationOptions>
    {
            ...
            : base(next, options)
        {
            ...
            _logger = app.CreateLogger<PayPalAuthenticationMiddleware>();
            ...
            _httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Microsoft Owin PayPal middleware");
        ...
        {
            return new PayPalAuthenticationHandler(_httpClient, _logger);
        }

        private static HttpMessageHandler ResolveHttpMessageHandler(PayPalAuthenticationOptions options)
        {
