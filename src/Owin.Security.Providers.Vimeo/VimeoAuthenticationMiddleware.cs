...
namespace Owin.Security.Providers.Vimeo
{
    public class VimeoAuthenticationMiddleware : AuthenticationMiddleware<VimeoAuthenticationOptions>
    {
            ...
            : base(next, options)
        {
            ...
            _logger = app.CreateLogger<VimeoAuthenticationMiddleware>();
        ...
        {
            return new VimeoAuthenticationHandler(_httpClient, _logger);
        }

        private static HttpMessageHandler ResolveHttpMessageHandler(VimeoAuthenticationOptions options)
        {
