    ...
    public class FreeConferenceCallAuthenticationHandler : AuthenticationHandler<FreeConferenceCallAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                // Get the FreeConferenceCall user
                ...
                var context = new FreeConferenceCallAuthenticatedContext(Context, user, accessToken)
                {
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:freeconferencecall:name", context.Name, XmlSchemaString, Options.AuthenticationType));
                }
                if (!string.IsNullOrEmpty(context.Link))
                {
                    context.Identity.AddClaim(new Claim("urn:freeconferencecall:url", context.Link, XmlSchemaString, Options.AuthenticationType));
                }
...
//                "&state=" + Uri.EscapeDataString(state) +
                "&response_type=" + Uri.EscapeDataString("token"); // or "code"
